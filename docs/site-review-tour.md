...
Home through learn, then Why Fairview. More pages when the scripts are ready.

Markers only appear with `?review=1`. Send reviewers: **`/?review=1`**

---

## How to walk it

1. Open `/?review=1`. Start at the home hero — strategy, then voice and tone.
2. Then the Home canvas marker. Then Photography direction. Then Wealth. Then Investment. Then Fees. Then Technology. Then Community. Then Answers. Then Learn. Then Why Fairview.
3. Until a file is in, the dock shows the script — including scroll and click cues. After you record, it plays.
4. Exit in the dock, or `?review=0`.

---

## How to record

- Drop files in `public/review/`.
- **Part 1:** `argument.mp4`
- **Voice and tone:** `voice-and-tone.mp4`
- **Part 2:** `home.mp4`
- **Photography direction:** `photography.mp4`
- **Part 3:** `wealth.mp4`
- **Part 4:** `investment.mp4`
- **Part 5:** `fees.mp4`
- **Part 6:** `technology.mp4`
- **Part 7:** `community.mp4`
- **Part 8:** `answers.mp4`
- **Part 9:** `learn.mp4`
- **Part 10:** `why-fairview.mp4`

---

## 01 · Strategy & positioning · `argument.mp4`

I want to share the exact strategy behind why I chose these words for the hero screen:
...
Now, a lot of firms fall into the trap of focusing exclusively on wealth growth. But when you’re talking to a family with ten or twenty million dollars, wealth growth is assumed—character and culture are not. High-net-worth clients already take it for granted that a firm with over two billion dollars in assets knows how to manage a portfolio. What they don’t take for granted is trust, character, and alignment.

They want to know: When push comes to shove, who actually owns this firm, and whose interests come first?

That’s why the hero screen leads with ownership rather than generic promises. While half the industry has quietly sold out, Fairview stayed independent. You turned down those buyouts. You helped your own team become partners. You do your own stock research in-house.

So what competitors cant buy is 1995. They can’t buy your in-house research book. They can’t buy a seventeen-person team where the people doing the work are actual owners. And they can’t buy a founder who turned down private equity buyouts because he’d rather say no to a check than compromise the firm.

In five seconds, this hero section takes your 30-year operational history and turns it into your biggest commercial advantage. It tells a serious family that Fairview isn’t just another asset manager—it’s an owner-operated shop built to protect them for the next thirty years.
...
**[Hero Screen / Opening]**
*(Visual: On the main hero screen showing the numbers 1995, 100% Employee-Owned, and $2.14 Billion.)*
...
*(Visual: Scroll down to the clean “Start Here” list.)*
...
*(Visual: Hover over and click into the Search bar.)*
...
*(Visual: Scroll down to the horizontal Team Rail and hover over the first featured video card.)*
...
**[Hero Photograph]**
*(Visual: Hovering over the candid black-and-white frame on the homepage under the primary metrics—then slowly scrolling through the secondary photo placements across the site.)*
...
## 03 · Wealth management · `wealth.mp4`

**[Hero Screen]**
*(Visual: On the Wealth Management hero screen addressing Wall Street.)*
...
*(Visual: Scroll down to the Services Rail and click through photo cards like Estate Planning, Family, and Income & Tax.)*
...
*(Visual: Scroll down to the onboarding section and click the path toggle so the route turns green.)*
...
*(Visual: Scroll to the Technology card and interact with the outside assets widget.)*
...
*(Visual: Scroll down past the kitchen table graphic to the Q&A carousel at the bottom.)*
...
## 04 · Investment management · `investment.mp4`

**[Hero Screen / Core Thesis]**
*(Visual: On the Investment hero screen showing “A ticker is just a string of letters. We buy what’s underneath it.”)*
...
*(Visual: Scroll down to the macro philosophy block.)*
...
*(Visual: Scroll down to the theme cards like AI, Electrification, Water, and hover over the 25–30 Holdings stat.)*
...
**[Closing Headline]**
*(Visual: Scroll to the bottom of the page showing “Several futures. One careful portfolio.”)*
...
**[Hero Screen / Published Fee Schedule]**
*(Visual: On the main Fees screen displaying the clean 1.00%, 0.75%, and 0.50% tiers.)*
...
*(Visual: Scroll down to the dark card titled “See it on your assets” and drag the asset slider across $5M, $10M, and $25M.)*
...
*(Visual: Hover over the disclaimer copy at the bottom of the calculator card.)*
...
## 06 · Technology · `technology.mp4`

**[Intro Animation & Hero Screen]**
*(Visual: Refresh or load the page to watch the opening animation cycle through “Internet, Computers, Cloud, Software” before landing on “Tools change. Relationships last.”)*
...
*(Visual: Scroll down through the text blocks detailing deeper analysis versus human judgment.)*
...
*(Visual: Scroll to the bottom paragraph featuring the 1995 philosophy quote.)*
...
## 07 · Community · `community.mp4`

**[Hero Screen / Hero Photo]**
*(Visual: On the main Community screen showing the high-impact Marin FC hero photo.)*
...
*(Visual: Scroll down to the copy detailing Brian, Peter, Andy, and Annie’s local involvement.)*
...
## 08 · Answers · `answers.mp4`

**[Hero Screen & Search Bar]**
*(Visual: On the main Answers page showing the category pills and the interactive search bar.)*
...
*(Visual: Click on question 03 “Do you have a minimum to work with you?” to show it opening its own dedicated sub-page URL.)*
...
*(Visual: Type “minimum” into the search bar, then switch tabs briefly to show the backend admin dashboard.)*
...
**[Hero Screen & Three Channel Bucket Cards]**
*(Visual: On the main Learn landing page showing the three giant vertical cards: Quarterly Letters, Investment Insights, and Planning.)*
...
*(Visual: Click into the Quarterly Letters bucket card to showcase the Q1 2026 letter layout.)*
...
*(Visual: Click through into an individual letter to show the editorial layout and blockquote styling.)*
...
*(Visual: Scroll to the footer showing the Greenbrae & Pittsburgh addresses, then jump back out to the main Learn overview.)*
