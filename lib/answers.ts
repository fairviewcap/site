...
export const ANSWER_CATEGORIES: AnswerCategory[] = [
    ...
    items: [
      {
        ...
        more: { href: "/contact", label: "Start a conversation" },
      },
      {
      ...
      },
      {
        ...
        more: {
          ...
          label: "How wealth management works here",
        },
      },
      {
      ...
      },
      {
        ...
        answer:
          "San Francisco Bay Area (Greenbrae, CA) and Pittsburgh, PA. We meet on your terms—phone, email, video, or in person. If it’s easier, we’ll come to you.",
        more: { href: "/contact", label: "Offices and contact" },
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        more: {
          href: "/work/wealth-management",
          label: "How the work actually runs",
        },
      },
      {
        ...
        more: {
          ...
          label: "How we research and build portfolios",
        },
      },
      {
        ...
        more: {
          href: "/work/wealth-management",
          label: "Plan, portfolio, and your world",
        },
      },
      {
        question: "Is financial planning included in the fee?",
        slug: "is-financial-planning-included-in-the-fee",
        answer:
          "Yes. Planning is part of the advisory fee—no separate planning charge. We start with your plan; the portfolio follows.",
        more: { href: "/firm/fees", label: "See the fee schedule" },
      },
      {
        question: "Do you advise on assets you don’t manage?",
        slug: "do-you-advise-on-assets-you-dont-manage",
        answer:
          "Yes. Real estate, a concentrated business stake, an old 401(k), private holdings—if it affects your financial life, we include it in the overall plan at no extra charge.",
        more: {
          href: "/work/wealth-management",
          label: "How we think about your whole picture",
        },
      },
      {
  ...
  },
  {
    id: "fees",
    title: "Fees",
    dek: "What you pay, in plain numbers.",
    items: [
      {
        question: "What are your fees?",
        slug: "what-are-your-fees",
        answer:
          "One advisory fee based on assets we manage: 1.00% on assets up to $5 million, 0.75% above $5 million through $10 million, and 0.50% above $10 million. Updated March 2026.",
        more: { href: "/firm/fees", label: "See the full fee schedule" },
      },
      {
        question: "What does the fee include?",
        slug: "what-does-the-fee-include",
        answer:
          "Financial planning, investment research, portfolio construction, ongoing guidance and reviews, and coordination across family accounts.",
        more: { href: "/firm/fees", label: "See the full fee schedule" },
      },
      {
        question: "Do you charge commissions?",
        slug: "do-you-charge-commissions",
        answer:
          "No. No commissions, and no separate planning fees. One fee based on the assets we manage for you.",
        more: { href: "/firm/fees", label: "See the full fee schedule" },
      },
      {
        question: "Do fees go down as assets grow?",
        slug: "do-fees-go-down-as-assets-grow",
        answer:
          "Yes. As assets increase, the percentage declines. We also combine assets across families, which can further reduce fees. Billed quarterly.",
        more: { href: "/firm/fees", label: "See the full fee schedule" },
      },
    ],
  },
  {
    ...
    items: [
      {
        question: "Who owns Fairview?",
        slug: "who-owns-fairview",
        answer:
          "The advisors who work here. The firm is 100% owned by the people who pick up when you call—not a bank, a board, or a private-equity buyer.",
        more: {
          href: "/firm/why-fairview#ownership",
          label: "Why Fairview stays independent",
        },
      },
      {
        question: "How much do you manage?",
        slug: "how-much-do-you-manage",
        answer:
          "About $2.14 billion under management, as of March 2026.",
        more: { href: "/firm/why-fairview", label: "The longer story" },
      },
      {
        question: "Do you hire salespeople or make cold calls?",
        slug: "do-you-hire-salespeople-or-make-cold-calls",
        answer:
          "No. We’ve never hired a salesperson or made a cold call. Every family at Fairview came because another client sent them.",
        more: { href: "/firm/why-fairview", label: "Why Fairview" },
      },
      {
        ...
        more: { href: "/login", label: "Client portal and custodian access" },
      },
      {
      ...
      },
      {
        ...
        slug: "how-do-you-handle-client-confidentiality",
        answer:
          "Even when we work with multiple generations of the same family, each relationship is treated as its own—information is never shared unless you ask us to.",
        more: { href: "/firm/privacy", label: "More on confidentiality" },
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        more: {
          href: "/work/investment-management",
          label: "Our core equity approach",
        },
      },
      {
        ...
        more: {
          href: "/work/investment-management",
          label: "How portfolios are built",
        },
      },
      {
    ...
    items: [
      {
        ...
        more: { href: "/login", label: "Client access" },
      },
      {
      ...
      },
      {
        ...
        more: { href: "/firm/technology", label: "Tools change. Judgment doesn’t." },
      },
      {
        ...
        more: { href: "/firm/technology", label: "How we use technology" },
      },
      {
...
export function allAnswerRecords(): AnswerRecord[] {
  return ANSWER_CATEGORIES.flatMap((c) =>
    c.items.map((item) => ({
      ...item,
      categoryId: c.id,
...
export function getAnswerBySlug(slug: string): AnswerRecord | undefined {
  return allAnswerRecords().find((item) => item.slug === slug);
}

/** Same category first, then other categories — up to `limit`. */
export function getRelatedAnswers(
  ...
  const records = allAnswerRecords().filter((r) => r.slug !== slug);
